...
const OriginalContent: React.FC<OriginalContentProps> = ({ content, pdfUrl }) => {
  return (
    <div className="bg-white/90 backdrop-blur rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
