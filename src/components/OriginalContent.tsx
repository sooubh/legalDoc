  ...
  return (
    <div className="bg-white/90 backdrop-blur rounded-2xl shadow-lg border border-gray-200 overflow-hidden flex flex-col" style={containerHeight ? { height: containerHeight } : undefined}>
      <div className="p-4 md:p-6 border-b border-gray-200">
        <h3 className="text-lg md:text-xl font-bold text-gray-900">Original Document</h3>
        <p className="text-gray-600 text-xs md:text-sm">Uploaded / pasted content</p>
      </div>
      {pdfUrl ? (
        ...
        <div className="p-4 md:p-6 max-h-[75vh] overflow-auto">
          <pre className="whitespace-pre-wrap break-words text-gray-800 text-[13px] md:text-sm leading-6">{content}</pre>
        </div>
      )}
    </div>
  );
