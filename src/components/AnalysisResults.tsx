...
import { ChevronDown, ChevronUp, AlertTriangle, CheckCircle, Clock, ExternalLink, FileText, ArrowLeft } from 'lucide-react';
          ...
          <div className="p-8 space-y-4">
            ...
            {analysis.clauses.map((clause) => (
              <div key={clause.id} className="border border-gray-200 rounded-lg">
                ...
                >
                  <div className="flex items-center space-x-3">
                    <span className={`px-2 py-1 rounded text-xs font-medium border ${getRiskColor(clause.riskLevel)}`}>
                      {getRiskIcon(clause.riskLevel)}
                      <span className="ml-1">{translations[language].riskLevels[clause.riskLevel]}</span>
                    </span>
                ...
                {expandedClauses.has(clause.id) && (
                  <div className="px-4 pb-4 space-y-4">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <h4 className="font-medium text-gray-900 mb-2">Plain English:</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-2">
                        <h4 className="font-bold text-gray-900">{risk.clause}</h4>
              ...
              {analysis.citations.map((citation, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-bold text-gray-900 mb-2">{citation.title}</h4>
                      <p className="text-gray-700 mb-3">{citation.description}</p>
                      <a
                        href={citation.url}
                        target="_blank"
