...
const ChatBot: React.FC<ChatBotProps> = ({ isOpen, onClose, isMinimized, onToggleMinimize }) => {
  ...
  return (
    <div className={`fixed inset-0 z-50 bg-black/50 backdrop-blur-sm transition-all duration-300 ${
      isOpen ? 'opacity-100 chatbot-backdrop-enter' : 'opacity-0 pointer-events-none chatbot-backdrop-exit'
    }`}>
      <div className={`absolute bottom-0 left-0 right-0 bg-white dark:bg-slate-900 rounded-t-3xl shadow-2xl transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-slate-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-slate-100">Legal Assistant</h3>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="bg-gray-100 dark:bg-slate-800 rounded-2xl px-4 py-3">
                      <div className="flex gap-1">
                        ...
                        <div className="w-2 h-2 bg-gray-400 rounded-full typing-indicator" style={{ animationDelay: '0.1s' }}></div>
